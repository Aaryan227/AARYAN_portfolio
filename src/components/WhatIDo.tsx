        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Expanding expertise in deep learning, LLMs, and real-world ML applications 
                to drive technical creativity in AI-driven backends.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                complex business logic, I build backends that scale securely.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Python</div>
